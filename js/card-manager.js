...
function createCards(){
	const cardsPortOrder = displayPortOrder();
	...
	const cardDataObjs = [{categorie:"Education" ,platform:"Python, OpenCV and Tkinter" ,pic:"printFailureDetection.png" ,title:"3D Print Failure Detection" 
						,hlink:"#" ,linkText:"Currently Under Development" 
						...
						,hlink:"https://github.com/adam-steven/Motion-Tracking-Camera" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/AI-Emotion-Detection" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/Game-AI-Comparison" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/Mobile-Game" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/MVC-Website" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/Secure-Messaging-System" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/Mandelbrot-Visualiser" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/Endless-Runner-Game" ,linkText:"Github Link" 
						...
						,hlink:"#" ,linkText:"No Link Avaliable" 
						...
						,hlink:"webgame/index.html" ,linkText:"Try It Here" 
						...
						,hlink:"https://github.com/adam-steven/Bash-Audio-Scrubber" ,linkText:"Github Link" 
						...
						,hlink:"https://github.com/adam-steven/adam-steven.github.io" ,linkText:"Github Link" 
						...
						,hlink:"https://globalgamejam.org/2018/games/pierat-radio" ,linkText:"GGJ Link" 
						...
						,hlink:"https://github.com/giodestone/Acorn-Fling-VR" ,linkText:"Github Link" 
	...
	if(cardsPortOrder != "noOrder")
		orderedCardFill(cardDataObjs, cardsPortOrder);
	else
		noOrderCardFill(cardDataObjs);
}

function noOrderCardFill(cardDataObjs)
{
...
function orderedCardFill(cardDataObjs, cardsPortOrder)
{
	const catEduc = document.getElementById("education");
	const catPers = document.getElementById("personal");
	const catWork = document.getElementById("work");
...
// <div class="card">
	...
	// <div class="card-body">
		// <div class="row">
			...
			// </div>
			// <div class="col-9">
				// <h4 class="card-title">TITLE <a href="HYPERLINK" class="btn">LINK TEXT</a></h4>
...
function constructCurrentCard(cardData)
{
	...
	if (cardData.hlink != "" && cardData.hlink != "#")
		card += "<a href='"+cardData.hlink+"' class='btn' target='_blank'>"+cardData.linkText+"</a></h4>";
	else
...
function checkElementRunThough(className){
	var numberOfElements = document.getElementsByClassName(className).length;
...
function changeCardOrder(toPlaceFirst){
	const url = 'index.html?portOrder='+toPlaceFirst+'#portfolio';
	window.location.href = url;
}

function displayPortOrder(){
	const queryString = window.location.search;
	const urlParams = new URLSearchParams(queryString);
	
	if(urlParams.has('portOrder'))
	{
		const firstCards = urlParams.get('portOrder');
		
		radiobtn = document.getElementById(firstCards);
